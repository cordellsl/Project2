...
AS SELECT COUNT(*) AS TEST FROM DATA_BY_COUNTRY
GROUP BY INDICATOR_CODE;


-- IGNORE WHATS BELOW HERE IT HAS HIVE CONVERT 
-- MYSQL COMMANDS AND DOESN'T CLEANSE THE DATA
...
-- DROP TABLE IF EXISTS DATA_BY_REQ;
